...
//func (c *Certificate) systemVerify(opts *VerifyOptions) (chains [][]*xCertificate, err error) {
//	return nil, nil
//}
...
// loadSystemRoots finds the macOS list of trusted root certificates
...
func verifyCertWithSystem(block *pem.Block, cert *x509.Certificate) bool {
